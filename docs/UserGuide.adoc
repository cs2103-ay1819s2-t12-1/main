...
* Each command has an alias using which the user can perform the same command but by typing lesser e.g. for the add command the user can type both: add n/John Doe or a n/John Doe.
