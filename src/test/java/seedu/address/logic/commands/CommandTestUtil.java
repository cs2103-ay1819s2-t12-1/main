...
public class CommandTestUtil {
    ...
    public static final String VALID_ID_AMY = "12334";
    public static final String VALID_ID_BOB = "00422";
    ...
    public static final String INVALID_ID_DESC = " " + PREFIX_ID + "a1234"; // beginning with space not allowed
    ...
    static {
        DESC_AMY = new EditCustomerDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withId(VALID_ID_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditCustomerDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withId(VALID_ID_BOB).withAddress(VALID_ADDRESS_BOB)
