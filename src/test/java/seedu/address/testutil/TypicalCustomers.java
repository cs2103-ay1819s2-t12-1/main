...
public class TypicalCustomers {
    ...
    public static final Customer VIP_PERSON = new CustomerBuilder().withName("I am VIP").withPhone("94824425")
            .withEmail("vip@example.com").withAddress("VIP street").withTags("VIP").build();
    public static final Customer VIP_PERSON2 = new CustomerBuilder().withName("I am also VIP").withPhone("34824425")
